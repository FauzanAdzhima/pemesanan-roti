                                                ...
                                                <div class="card mx-4 mb-3 text-center border-dark" style="width: 19rem;">
                                                    <div class="card-body">
                                                        <h5 class="card-title text-center">
                                                            @if ($kasir->image)
                                                                <img src="{{ asset('storage/' . $kasir->image) }}" alt="{{ $kasir->nama }}" class="img-thumbnail" style="width: 6em; height: 8em;">
                                                            @else
                                                                <img src="{{ asset($default_img='/storage/cashier-images/default-avatar.png') }}" alt="{{ $kasir->nama }}" class="img-thumbnail" style="width: 6em; height: 8em;">
                                                            @endif
                                                        </h5>
                                                            ...
                                                            <div class="row d-flex-justify-items-center">
                                                                <div class="col">
                                                                    <p class="text-center">Date created<br>
                                                                        <span class="fw-bold">{{ $kasir->created_at->format('d-m-Y') }}</span>
                                                                    </p>
                                                                </div>
                                                                <div class="col">
                                                                    <p class="text-center">Last updated<br>
                                                                        <span class="fw-bold">{{ $kasir->updated_at->format('d-m-Y') }}</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                            action="{{ route('admin.destroy', $kasir->id) }}" method="POST">
                                                            <div class="container-fluid">
                                                                <div class="row d-flex justify-items-center">
                                                                    <div class="col">
