                            ...
                            <div class="col-md-5">
                                ...
                                <div class="card border-0 shadow rounded">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('customer-pass-update', $customer->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')                                                                                        
                                            ...
                                            <div class="row align-items-center mb-3">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" class="form-control" name="new_pass_confirmation">
                                            ...
                                            <div class="d-flex justify-content-center align-items-center mt-3">    
                                                ...
                                                <div class="col-1"></div>
                                                <a href="{{ route('customer.index') }}" type="button" class="btn btn-secondary col-md-3">Back</a> 
                                            </div>
