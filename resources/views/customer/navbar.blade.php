    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav px-4">
                ...
                <a class="nav-link fw-bold {{ ($page === 'Home') ? 'active' : '' }}" href="{{ ($mode === 'tamu') ? '/' : '/customer' }}">Home</a>
                ...
                @else                
                    ...
                    <div class="" style="min-width: 1rem;"></div>
                    <a class="nav-link fw-bold {{ ($page === 'Profil Pelanggan') ? 'active' : '' }}" href="{{ route('customer-profile') }}">Profil</a>
                    <div class="" style="min-width: 1rem;"></div>
