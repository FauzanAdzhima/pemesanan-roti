<div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0" style="background-color: rgb(255, 208, 0);">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <div class="dropdown pb-4">
                    <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        @if (empty($image))
                            <img src="{{ asset($default_img='/storage/cashier-images/default-avatar.png') }}" alt="{{ $name }}" width="30" height="30" class="rounded-circle">
                        @else
                        {{-- @php
                            $image = explode('/', $kasir['image']);
                            $image_path = $image[1].'/'.$image[2];
                        @endphp --}}
                            <img src="{{ asset('storage/' . $image) }}" alt="{{ $name }}" width="30" height="30" class="rounded-circle">
                        @endif                        
