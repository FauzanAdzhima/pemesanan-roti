                ...
                <td class="align-middle">
                    <div class="container text-center">
                        <h2 style="font-size: 4em">
                            <p class="text-dark">Profil Kasir</p>                            
                        </h2>
                    </div>                
                                        ...
                                        <form action="{{ route('cashier-update', $cashier->id) }}" method="POST">
                                            ...
                                            <div class="row align-items-center mb-3">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ $cashier->nama }}" required>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="nik" value="{{ $cashier->nik }}">
                                            ...
                                            <div class="form-group">
                                                <div class="d-flex inline justify-content-between">
                                                    ...
                                                    <a href="{{ route('cashier-profile-pass') }}" class="text-decoration-none">Ubah Password</a>
                                                </div>
                                            ...
                                            <div class="d-flex justify-content-center align-items-center mt-3">    
                                                ...
                                                <div class="col-1"></div>
                                                <a href="{{ route('cashier.index') }}" type="button" class="btn btn-secondary col-md-3">Back</a> 
                                            </div>
