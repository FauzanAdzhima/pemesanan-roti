                            ...
                            <div class="card-body">
                                <form method="POST" action="/register-customer">
                                    ...
                                    <div class="row align-items-center mb-2">
                                        <div class="col">
                                            <div class="form-floating">
                                                <input type="text"
                                                    class="form-control @error('nama_input') is-invalid @enderror"
                                                    id="nama_input" aria-describedby="namaAlert" name="nama"
                                        ...
                                        <div class="col">
                                            <div class="form-floating">
                                                <input type="email"
                                                    class="form-control @error('email_input') is-invalid @enderror"
                                                    id="email_input" aria-describedby="emailAlert" name="email"
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control @error('kontak_input') is-invalid @enderror"
                                            id="kontak_input" aria-describedby="kontakAlert" name="kontak"
                                            placeholder="kontak" value="{{ old('kontak') }}">
                                    ...
                                    <div class="form-group form-floating mb-2">
                                        <textarea class="form-control @error('alamat') is-invalid @enderror"
                                            placeholder="Leave a comment here" id="alamat" style="height: 100px"
