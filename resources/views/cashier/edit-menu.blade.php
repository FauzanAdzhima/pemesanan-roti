                                        ...
                                        <form action="{{ route('update-menu', $menu->id) }}" method="POST"
                                                ...
                                                <div class="col">
                                                    <div class="form-group form-floating">
                                                        <select class="form-select" id="floatingSelect"
                                                            ...
                                                            <option value="1"
                                                                {{ $menu->category_id == '1' ? 'selected' : '' }}>Roti
                                                            </option>
                                                            <option value="2"
                                                                {{ $menu->category_id == '2' ? 'selected' : '' }}>Cake
                                                            </option>
                                                            <option value="3"
                                                                {{ $menu->category_id == '3' ? 'selected' : '' }}>
                                                                Makanan</option>
                                                            <option value="4"
                                                                {{ $menu->category_id == '4' ? 'selected' : '' }}>
                                                                Minuman</option>
                                                        </select>
                                            ...
                                            <div class="form-group form-floating mb-3">
                                                <input type="text" class="form-control @error('harga') is-invalid @enderror"
                                                    name="harga" value="{{ $menu->harga }}" required>
                                            ...
                                            <div class="row align-items-center mb-3">
                                                <div class="col">
                                                    ...
                                                    <div class="form-group d-flex justify-items-left">
                                                        <div class="input-group">
                                                            <button
                                                                class="btn {{ $menu->status === 'Tersedia' ? 'btn-outline-primary' : 'btn-secondary text-white' }} rounded-pill px-5"
                                                                type="button" id="status-button" onclick="statusToggle()"
                                                                style="min-width: 15vw;">{{ $menu->status }}</button>
                                                            <input type="hidden" class="form-control" placeholder=""
                                                                aria-label="Example text with button addon"
                                                                aria-describedby="button-addon1" id="status" name="status"
                                                                value="{{ $menu->status }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <div class="form-group d-flex justify-items-left">
                                                        <div class="input-group">
                                                            <button class="btn btn-outline-danger rounded-start"
                                                                type="button" id="terjual-button"
                                                                onclick="counterResetToggle()">Reset</button>
                                                            <input type="text" class="form-control" placeholder=""
                                                                aria-label="Example text with button addon"
                                                                aria-describedby="button-addon1" id="terjual" name="terjual"
                                                                value="{{ $menu->terjual }}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center justify-content-center mt-3">
                                                @if ($menu->image)
                                                    <img src="{{ asset('storage/' . $menu->image) }}"
                                                        class="img-fluid img-preview" style="width: 50%; height: auto;">
                                                @else
                                            ...
                                            <div class="d-flex justify-content-center align-items-center mt-3">
                                                ...
                                                <div class="col-1"></div>
                                                <a href="{{ route('cashier-menu') }}" type="button"
